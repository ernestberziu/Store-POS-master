...
let by_user = 0;
let by_status = 1;
const atob = (value) => Buffer.from(value, "utf8").toString("base64")
$(function () {
...
if (auth == undefined) {
    ...
    $(document).ready(function () {
        ...
        function loadProducts() {
            ...
            $.get(api + 'products/products', function (data) {
        ...
        function barcodeSearch(e) {
            ...
            $.ajax({
                url: api + 'products/product/barcode',
                type: 'POST',
                ...
                success: function (data) {
                    if (data.barcode != undefined && data.quantity >= 1) {
                        ...
                        Swal.fire(
                            'Not Found!',
                            '<b>' + $("#barCode").val() + '</b> is not a valid barcode!',
                            'warning'
                        );
        ...
        $('body').on('click', '#jq-keyboard button', function (e) {
            ...
            if ($("#barCode").val() != "" && pressed[2] == "enter") {
                barcodeSearch(e);
            }
        });
